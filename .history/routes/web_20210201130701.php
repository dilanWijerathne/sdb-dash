...
Route::get('/logout', [DashController::class, 'logout']);
...
Route::get('/applicants_fds', [DashController::class, 'calldit_fds']);
...
Route::get('/applicant-details-ref', [DashController::class, 'applicant_details_page_by_ref']);
