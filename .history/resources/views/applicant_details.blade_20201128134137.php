      ...
      function msg(ref){
          ...
          $.ajax({
            ...
            for(var i=0; i<k.length;i++){
                var t = '<div class="col-sm-12" style="margin-top: 50px" ><div class="col-sm-10"><dl><dt> ->  '+k[i]['from_user']+' for application no '+k[i]['ref']+' of NIC '+k[i]['nic']+'</dt><dd> '+k[i]['msg']+'</dd><dd>'+k[i]['created_at']+'</dd></dl><hr></div>         <hr></div>';
                st = st.concat(t);
            }
