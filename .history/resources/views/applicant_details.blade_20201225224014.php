  ...
  <div class="comlist form-group margin-bottom-none">
                ...
                <div class="post">
                  ...
                  <div class="row margin-bottom">
                    ...
                    <div class="col-sm-6">
                      <img  height="500" class="img-responsive" src="{{env('CORE_URL')}}/sdbl/public/{{$nicf['file_path']}}" alt="Photo">
                    </div>


                    <div class="col-sm-6">
                        <img height="500" class="img-responsive" src="{{env('CORE_URL')}}/sdbl/public/{{$nicr['file_path']}}" alt="Photo">
                      </div>
