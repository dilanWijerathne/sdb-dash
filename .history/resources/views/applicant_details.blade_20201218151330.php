        ...
        <div class="box box-warning collapsed-box">
          ...
          <div class="box-body">
            ...
            if(isset($js['pupose'])){
                ...
                echo '  <ul style="list-style-type:none;  margin: 0;  margin: 0;" class="list-group list-group-unbordered">';
            ...
            if(isset($js['source_funds'])){
               ...
               $source_of_funds = json_decode($source_of_funds,true);
                ...
                echo '  <ul style="list-style-type:none;" class="list-group list-group-unbordered">';
