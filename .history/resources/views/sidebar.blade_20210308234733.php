    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="public/dist/img/person-icon.png" class="img-circle" alt="User Image">
        </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview menu-open">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a target="blank" href="{{env('CORE_URL')}}/sdbl/log-viewer"><i class="fa fa-circle-o"></i>BE Logs Review</a></li>
            <li class="active"><a target="blank" href="{{env('CORE_URL')}}/sdb-dash/log-viewer"><i class="fa fa-circle-o"></i>Dash Logs Review</a></li>
            <li class="active"><a target="blank" href="{{env('CORE_URL')}}/sdbl/api/export"><i class="fa fa-circle-o"></i>Download Merged Exl</a></li>
            @endif
