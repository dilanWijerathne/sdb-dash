      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview menu-open">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a target="blank" href="http://10.101.6.198/sdbl/logs"><i class="fa fa-circle-o"></i>Logs Review</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="pages/forms/advanced.html"><i class="fa fa-circle-o"></i> Stats</a></li>
              <li><a href="pages/forms/editors.html"><i class="fa fa-circle-o"></i> Wiki</a></li>
            </ul>
          </li>
