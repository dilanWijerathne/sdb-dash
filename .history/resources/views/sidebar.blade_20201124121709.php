      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview menu-open">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a target="blank" href="http://10.101.6.198/sdbl/logs"><i class="fa fa-circle-o"></i>BE Logs Review</a></li>
            <li class="active"><a target="blank" href="http://10.101.6.198/sdb-dash/log-viewer"><i class="fa fa-circle-o"></i>Dash Logs Review</a></li>
          </ul>
        </li>
