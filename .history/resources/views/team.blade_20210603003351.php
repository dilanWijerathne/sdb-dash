      ...
      function addTeamMember(){
        ...
        if(empid!=null|empid!=""|empid!=" "){
            $.ajax({
                method: "POST",
                url: "api/new_member",
                data: {name, email, password, password_c, mobile, role, branch,emp:empid}
                })
                .done(function( msg ) {
            ...
            alert("Provide valid employee id");
        }
      ...
      function check_emp_id(){
        ...
        $.ajax({
                ...
                .done(function( msg ) {
                   ...
                   //$("#InputMobile").val();
                    $("#InputName").val(emp["data"]['emp_finit']);
                    $("#InputEmail").val(emp["data"]['emp_email']);
                   // $("#InputPassword").val(emp["data"]['emp_branch']);
            ...
            <form role="form">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <option value="teamid">Team IT</option>
                        </select>
                    </div>
