        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <h3 class="profile-username text-center"> {{$Applicant['nic']}} </h3>
              ...
              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b>Date of birth</b> <a class="pull-right"> {{$Applicant['birth_day']}}- {{$Applicant['birth_month']}}- {{$Applicant['birth_year']}} </a>
                </li>
