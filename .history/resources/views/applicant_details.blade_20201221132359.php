              ...
              for($i=0;$i<count($js); $i++){
                ...
                echo '  <div class="info-box bg-yellow">
                          ...
                          <div class="info-box-content">
                            <span class="">Name : '.$js[$i]['title'].'. '.$js[$i]['full_name'].'</span>
                            <span class=""> Address : '.$js[$i]['address'].'</span>
                            <span class=""> DOB : '.$js[$i]['dob'].'</span>
                            <span class=""> Contact No : '.$js[$i]['contact_number'].'</span>
                            <span class=""> Address : '.$js[$i]['address'].'</span>
