...
<head>
    ...
    <title>SDB Customer obboarding dashboard</title>
    ...
    <script>
        ...
        function login(){
            ...
            var un = $("#your_name").val();
            var pw = $("#your_pass").val();


            $.ajax({
                    method: "GET",
                    url: "/sdb-dash/user-login",
                ...
                .done(function( msg ) {
                    ...
                    alert(  msg );
                    if(msg==="success"){
                        window.location.replace("/sdb-dash/dashboard");
                    }
            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        <figure><img src="public/colorlib-regform-7/images/signin-image.jpg" alt="sing up image"></figure>
                    ...
                    <div class="signin-form">
                        ...
                        <form method="POST"  class="register-form" id="login-form">
                            ...
                            <div class="form-group form-button">
                                <input onclick="login()" name="signin" id="signin" class="form-submit" value="Log in"/>
                            </div>
                        </form>
                       <!---
