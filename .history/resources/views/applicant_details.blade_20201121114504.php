          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <ul class="list-group list-group-unbordered">
                ...
                <li class="list-group-item">
                  <b>Existing customer</b> <a class="pull-right">CIF  {{$cif['cif']}}</a>
                </li>
                @endif
              ...
              <div class="active tab-pane" id="activity">
                ...
                <div class="post clearfix">
                  <div class="user-block">
                    <img class="img-circle img-bordered-sm" src="public/dist/icons/worker-green-icon" alt="User Image">
                        <span class="username">
                          <a href="#">Line of Work</a>
                ...
                <div class="post">
                  ...
                  <div class="row margin-bottom">
                    ...
                    <div class="col-sm-6">
                      <div class="row">
                        <div class="col-sm-6">
                          <img class="img-responsive" src="public/dist/img/photo2.png" alt="Photo">
                          <br>
                          <img class="img-responsive" src="public/dist/img/photo3.jpg" alt="Photo">
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
